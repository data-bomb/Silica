...
|---------:|-----------|------|
| Auto Teams Mode Select | 1.0.2 | [Download](https://raw.githubusercontent.com/data-bomb/Silica_ListenServer/blob/main/Si_AutoTeamsSelect/bin/Si_AutoTeamsSelect.dll) |
