...
|---------:|-----------|------|
| Auto Teams Mode Select | 1.0.2 | [Download](Si_AutoTeamsSelect/bin/Si_AutoTeamsSelect.dll) |
| Mapcycle | 1.0.1 | Broken |
| Surrender Command | 1.1.5 | [Download](Si_SurrenderCommand/bin/Si_SurrenderCommand.dll) |
| Auto Kick on Negative Kills | 1.0.5 | [Download](Si_AutoKickNegativeKills/bin/Si_AutoKickNegativeKills.dll) |
| Headquarterless Humans Lose | 1.0.6 | [Download](Si_HQlessHumansLose/bin/Si_HQlessHumansLose.dll) |
| Basic Team Balance | 0.9.2 | Broken |
| Basic Banlist | 1.0.0 | [Download](Si_BasicBanlist/bin/Si_BasicBanlist.dll) |
